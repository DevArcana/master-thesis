...
These actions are mapped to corresponding operators, with exception of the first idle action that is represented by a lack of operator being proposed.
...
\begin{figure}[H]
    \centering
    \subfigure[Visualization of the agent's ability to perceive other agents in range of sight]{\includegraphics[width=0.48\textwidth]{images/visibility/agent47.png}\label{fig:images/visibility/agent47.png}}
    \hspace*{\fill}
    \subfigure[Visualization of the agent's ability to remember agent's last position]{\includegraphics[width=0.48\textwidth]{images/visibility/agent47_moved.png}\label{fig:images/visibility/agent47_moved.png}}
...
% It correlates with the SIR model parameters $\beta = 0.03, \gamma = 0.01, N = 40$ as shown in figure \ref{fig:images/chapter2/experiment3.png}.
...
\subsection{Experiment 5 - influence of population density}
...
The last simulation as shown in figure \ref{fig:map4_lifetime} shows a flat segment of the infected agents on subfigure \ref{fig:map4_lifetime_d}.
